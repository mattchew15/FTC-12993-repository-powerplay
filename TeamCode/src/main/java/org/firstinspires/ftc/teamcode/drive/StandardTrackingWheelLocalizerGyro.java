 ...
 */
@Config
public class StandardTrackingWheelLocalizerGyro extends ThreeTrackingWheelLocalizer {
    ...
    public static double FORWARD_OFFSET = -3.3; // in; offset of the lateral wheel
    ...
    public StandardTrackingWheelLocalizerGyro(HardwareMap hardwareMap) {
        super(Arrays.asList(
