...
public class HighSpeedCamera {
    ...
    public void initializeCamera(HardwareMap hardwareMap){
        ...
        camera = OpenCvCameraFactory.getInstance().createWebcam(hardwareMap.get(WebcamName.class, "Highspeedcamera"), cameraMonitorViewId);
    ...
    public void detectAprilTag(Telemetry telemetry){
    ...
    public double returnTagPosition(Telemetry telemetry){
    ...
    public double returnpitch(AprilTagDetection detection){
