...
public class TwoWheelTrackingLocalizer extends TwoTrackingWheelLocalizer {
    ...
    public static double PARALLEL_X =  3.55; // X is the up and down direction
    public static double PARALLEL_Y = -3.3; // Y is the strafe direction

    public static double PERPENDICULAR_X = -3.3;
    ...
    public double getHeading() {
        //return drive.getRawExternalHeading(); // this is changed
